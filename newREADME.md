...
## Top-level files
~~For the overview files, there are two sources that our standard outlines. Optionally a classes file may be provided, but is optional.~~ CHANGE THIS
...
**Sounds Localized with Acoustic Monitoring (SLAM)**  (FIX THIS)  
...
*ask leonardo about ideas for this!
...
Examples of audio folder organization
...
| w | relative_path | point_id | start_timestamp | 
| --- | --- | --- | ---| 
| aru001_20250101_060000 | audio/aru001/20250101_060000.WAV | aru001 | 2025-01-01T06:00:00.000-05:00 |

### Example 3: Long audio files nested by recorder and other category (idea?)
```
`audio/`
├── deployment2025/
│	├──aru001/
